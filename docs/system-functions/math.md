...
> Synonyms for search: математика, is_GT, is_LT, is_GE, is_LE, is_EQ, is_NE, is_abs, is_infinity, is_random, is_random_get_key, is_random_set_key, is_min, is_max, is_eps, is_fpart, is_ipart, is_rounded, is_ceil, is_floor, is_zero, is_finite, is_mod, is_div, is_pow, is_log10, is_control_EAN_13, is_avg, is_in_radians, is_in_degrees, is_cos, is_sin, is_atan, is_atan2, is_sqrt, is_horizontal_angle, сравнение, округление, тригонометрия, модуль, случайные числа
