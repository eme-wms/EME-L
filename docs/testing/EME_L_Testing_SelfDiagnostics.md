...
Синонимы: самодиагностика, RobotHealer, healClasses, KPI, тест здоровья БД, DBWatch, дозор базы данных, CIRobot, роботы-тестировщики, UI-тест, is_run_dbtest, is_vfs_test, is_test_block_write
